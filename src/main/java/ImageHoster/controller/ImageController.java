...
public class ImageController {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        //add image in the model
        model.addAttribute("image", image);

        //check if the current user is the owner of image
        //if yes, then direct the user to edit page, also add existing tags text in  model
        //if no, the direct user to images/image page (same page), also add editError key and existing tags list in model
